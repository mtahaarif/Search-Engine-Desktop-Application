...
constexpr auto qt_meta_stringdata_CLASSGUIENDCLASS = QtMocHelpers::stringData(
    ...
    "link",
    "on_verticalScrollBar_rangeChanged",
    "min",
    "max",
    "on_verticalScrollBar_actionTriggered",
    "action",
    "on_verticalScrollBar_customContextMenuRequested",
    "pos",
...
Q_CONSTINIT const QMetaObject GUI::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSGUIENDCLASS_t,
        ...
        // method 'on_verticalScrollBar_rangeChanged'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        ...
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<int, std::false_type>,
        // method 'on_verticalScrollBar_customContextMenuRequested'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
